...
このプロジェクトは、2026年7月26日に開催される「CNPトレカ交流会 in 名古屋」のランディングページです。
...
├── images/             # 画像ファイル
│   ├── hero/
│   │   ├── hero_2026-04-18.png  # 2026/04/18 開催分（アーカイブ）
│   │   ├── hero_2026-05-17.png  # 2026/05/17 開催分（アーカイブ）
│   │   ├── hero_2026-06-07.png  # 2026/06/07 開催分（アーカイブ）
│   │   └── hero_2026-07-26.png  # 2026/07/26 開催分（最新）
│   ├── 10.応援.png
│   ├── 3.世界猫の日（８月８日）.png
