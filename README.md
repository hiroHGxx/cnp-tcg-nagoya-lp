...
このプロジェクトは、2025年12月7日に開催される「CNPトレカ交流会 in 名古屋」のランディングページです。
...
│   │   ├── hero_2025-10-12.png  # 2025/10/12 開催分（アーカイブ）
│   │   ├── hero_2025-11-02.png  # 2025/11/02 開催分（アーカイブ）
│   │   └── hero_2025-12-07.png  # 2025/12/07 開催分（最新）
│   ├── 10.応援.png
│   ├── 3.世界猫の日（８月８日）.png
